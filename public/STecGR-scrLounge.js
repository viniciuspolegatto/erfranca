...
let endpoint = 'https://raw.githubusercontent.com/viniciuspolegatto/apiSebraetecSenaiSp/main/produtoSebraetecGanhosRapidos.json';
    ...
    produtos.forEach(produtoUnico => {
      ...
      elementoParaInserirProdutos.innerHTML += `
        <tr>
          ...
          <td style="border: 1px solid black; padding: 8px"><a href="STecGR-dadosContrato.html">CONTRATAR</a></td>
