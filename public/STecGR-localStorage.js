  ...
  tabelaPrecoForma.innerHTML = `
    ...
    <div>
        ...
        <tr>
           ...
           <td style="border: 1px solid black; padding: 8px">R$ ${(servicoSTecSenaiValor * 0.826998171).toFixed(2)}</td>
       </tr>
        <tr>
           <td style="border: 1px solid black; padding: 8px"><b>VALOR PAGO PELO CLIENTE</b></td>
           <td style="border: 1px solid black; padding: 8px">R$ ${(servicoSTecSenaiValor * 0.173001829).toFixed(2)}</td>
       </tr>
        <tr>
